...
cp ~/.local/share/zen/configs/alacritty.toml ~/.config/alacritty/alacritty.toml
cp ~/.local/share/zen/configs/alacritty/shared.toml ~/.config/alacritty/shared.toml
...
source ~/.local/share/omakub/zen/install/desktop/set-alacritty-default.sh
